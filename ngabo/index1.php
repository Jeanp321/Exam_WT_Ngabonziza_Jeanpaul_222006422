  ...
  <header>
    <nav>
      ...
      <ul>
        ...
        <li><a href="#skinProduct">skinProduct</a></li>
  ...
  <!-- Home Section -->
      <section id="home">
        <div class="container home">
          <h1>skin care products<br /> shine like diamond</h1>
          ...
          <div class="buttons">
            <button class="btn"> <a href="#skinProduct">Learn More</a> </button>
...
<!-- skinProduct Section -->
    ...
    <section id="program">
      <div class="container pro_wraper">
        <h1>About Our skinProduct</h1>
        <div class="pro_container">
          <div class="pro_card">
            <h2>Comprehensive Curriculum</h2>
            <p>Our skinProduct education program covers a wide range of topics, from school and institutions to sustainable living and increase beautful for ever one using our product. We provide a holistic learning experience that empowers participants to make informed decisions and take action to protect the planet.</p>
          </div>
          <div class="pro_card">
            <h2>Hands-On Approach</h2>
            <p>We believe in a hands-on, experiential approach to learning. Our skinProduct incorporate interactive workshops, field trips, and real-world projects that allow participants to apply their knowledge and develop practical skills for environmental stewardship.</p>
          </div>
          <div class="pro_card">
...
<table border="1" cellspacing="0" cellpadding="0" width="80%">
    ...
    <footer>
      <div class="container footer">
        <p>&copy;All Right Reserved By jean paul 2024</p>
      </div>
    </footer>
